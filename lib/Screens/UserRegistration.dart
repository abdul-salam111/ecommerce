...
import 'package:ecommerce/Screens/verfiyEmail.dart';
import 'package:ecommerce/modals/registrationModal.dart';
...
class _UserRegistrationState extends State<UserRegistration> {
  ...
  Future postUserData() async {
    ...
    registrationModal.firstName = firstnamecontroller.text.trim();
    ...
    try {
      await _auth
        ...
        Navigator.of(context)
            .push(MaterialPageRoute(builder: (builder) => VerifyEmail()));
      });
        ...
        leading: GestureDetector(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (builder) => const SignInUser()));
            },
